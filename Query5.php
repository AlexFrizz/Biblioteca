...
<body>
    <label>Per effettuare una nuova ricerca premi <a href="Query5.html">qui</a></label>
	<br>
...
*/
        if($matricola!=NULL)
        {
            ...
            LEFT JOIN PRENDE ON UTENTE.NUMERO_MATRICOLA = PRENDE.MATRICOLA
            LEFT JOIN LIBRO ON PRENDE.IDLIBRO = LIBRO.ID_LIBRO
            WHERE UTENTE.NUMERO_MATRICOLA = '$matricola'";
			...
			if($result && mysqli_num_rows($result)>0)
            {
				...
				echo "<center><h4 style='color: red;'>Non esiste nessun utente che soddisfa i parametri inseriti</h4></center>";
		}
        mysqli_close($link);
        ?>
</body>
